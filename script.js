    ...
    projects: [
        {
            ...
            description: "Quranic Insights is an application designed to explore the profound wisdom of the Quran. It provides access to all Surahs enriched with translations and interpretations, offering a user-friendly experience for spiritual guidance, scholarly study, or personal reflection. Quranic Insights leverages the power of MongoDB, JavaScript, and HTML to deliver a seamless and dynamic user experience."
        },
        {
            title: "Redis Database | Self-made | CPP",
            description: "This project implements various Redis data structures using C++ as part of the final project for the Data Structures and Algorithms course. The implementation includes several key functionalities for Redis data structures such as Strings, Hashes, Sets, Sorted Sets, and Lists."
        },
        {
            title: "Paint App | Python",
            description: "This project is a simple paint application created using Python and the Tkinter library. It allows users to draw various shapes, lines, and curves on a canvas. The application provides several tools for drawing, including brushes, lines, rectangles, ovals, circles, and curves, with options for color and fill."
        },
        {
            title: "Chess Game | CPP",
            description: "The Chess Game Project is designed to provide a comprehensive and engaging chess-playing experience, featuring various advanced functionalities to enhance gameplay. Developed using SFML (Simple and Fast Multimedia Library), the game includes essential chess mechanics and additional features such as pawn promotion, highlighting legal moves, and check/self-check detection."
        },
        {
            title: "Shogi Game | CPP",
            description: "It is a console-based Shogi Game project! This is a C++ implementation of the traditional Japanese board game, Shogi. Shogi, also known as Japanese chess, is a two-player strategy game that offers deep strategic gameplay with its unique set of rules and piece movements. Some of the features included in this game are rules implementation, game state saving, pieces legalities, visual board display, piece movement and capture mechanics, command-line interface, and much more."
        },
        {
            title: "Snake Game | CPP",
            description: "This project encapsulates the classic Snake Game, a timeless favorite that tests reflexes and strategic thinking. The game is built using C++ and offers a modern twist on the traditional gameplay while maintaining its nostalgic charm. Whether you're a seasoned developer or a beginner looking to explore game development, this project provides an excellent opportunity to delve into coding and have fun along the way."
        }
    ],
    skills: {
        programming: ["C++", "C#", "Python", "JavaScript", "HTML/CSS"],
        databases: ["SQL", "MongoDB", "Redis", "Azure"],
        cloud: ["MS Azure", "AWS", "GCP"],
        tools: ["GitHub", "MongoDB Atlas", "VS Code", "Visual Studio", "Azure Data Factory", "SFML"]
    }
};
